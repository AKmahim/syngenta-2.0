...
--
-- Host: localhost:3306
-- Generation Time: Jan 03, 2024 at 08:11 PM
...
--
-- Table structure for table `location_dates`
--
...
--
-- Dumping data for table `location_dates`
--

INSERT INTO `location_dates` (`id`, `program_id`, `district`, `date`, `created_at`, `updated_at`) VALUES
(3, 5, 'Khulna', '2023-12-06', NULL, NULL),
(4, 5, 'Sylhet', '2024-02-16', NULL, NULL),
(5, 6, 'Narayanganj', '2024-01-06', NULL, NULL),
(6, 6, 'Dhaka', '2024-02-15', NULL, NULL),
(7, 6, 'Khulna', '2024-01-06', NULL, NULL),
(8, 7, 'Barisal', '2024-02-14', NULL, NULL),
(9, 7, 'Manikganj', '2024-06-17', NULL, NULL),
(10, 7, 'Rangpur', '2024-08-13', NULL, NULL),
(11, 7, 'Netrakona', '2024-05-01', NULL, NULL);
...
(5, '2019_11_27_040657_create_divisions_table', 2),
(6, '2019_11_27_040723_create_districts_table', 2),
(7, '2019_11_27_040803_create_upazilas_table', 2),
(8, '2021_09_13_035432_create_unions_table', 2),
(9, '2023_12_31_074824_create_programs_table', 3),
(10, '2023_12_31_075710_create_location_dates_table', 4);
...
INSERT INTO `programs` (`id`, `program_title`, `quantity`, `outreach`, `created_at`, `updated_at`) VALUES
(5, 'seed b', 10, 42, '2023-12-31 02:59:15', NULL),
(6, 'efaz vai', 1, 100, '2024-01-01 03:04:50', NULL),
(7, 'Testing map location highlight', 500, 140, '2024-01-02 09:53:10', NULL);
...
(1, 'Syngenta Bangladesh', 'admin@syngenta.com', NULL, '$2y$12$/e6wmX9UgzLylk2Jlw.sLu03XK8jtEkIBbabqygpdbSHmygq8dZlm', NULL, '2023-12-28 01:12:37', '2023-12-28 01:12:37');
...
--
-- Indexes for table `location_dates`
--
ALTER TABLE `location_dates`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `location_dates`
--
ALTER TABLE `location_dates`
